...
; SDAG-UNCHECKED-LABEL: test_auth_too_large_discriminator:
; SDAG-UNCHECKED:       ; %bb.0:
; SDAG-UNCHECKED-NEXT:    mov w8, #65536
; SDAG-UNCHECKED-NEXT:    bfi x1, x8, #48, #16
; SDAG-UNCHECKED-NEXT:    mov x16, x0
; SDAG-UNCHECKED-NEXT:    autda x16, x1
; SDAG-UNCHECKED-NEXT:    mov x0, x16
; SDAG-UNCHECKED-NEXT:    ret
;
; GISEL-UNCHECKED-LABEL: test_auth_too_large_discriminator:
; GISEL-UNCHECKED:       ; %bb.0:
; GISEL-UNCHECKED-NEXT:    movk x1, #0, lsl #48
; GISEL-UNCHECKED-NEXT:    mov x16, x0
; GISEL-UNCHECKED-NEXT:    autda x16, x1
; GISEL-UNCHECKED-NEXT:    mov x0, x16
; GISEL-UNCHECKED-NEXT:    ret
;
; SDAG-CHECKED-LABEL: test_auth_too_large_discriminator:
; SDAG-CHECKED:       ; %bb.0:
; SDAG-CHECKED-NEXT:    mov w8, #65536
; SDAG-CHECKED-NEXT:    bfi x1, x8, #48, #16
; SDAG-CHECKED-NEXT:    mov x16, x0
; SDAG-CHECKED-NEXT:    autda x16, x1
; SDAG-CHECKED-NEXT:    mov x0, x16
; SDAG-CHECKED-NEXT:    ret
;
; GISEL-CHECKED-LABEL: test_auth_too_large_discriminator:
; GISEL-CHECKED:       ; %bb.0:
; GISEL-CHECKED-NEXT:    movk x1, #0, lsl #48
; GISEL-CHECKED-NEXT:    mov x16, x0
; GISEL-CHECKED-NEXT:    autda x16, x1
; GISEL-CHECKED-NEXT:    mov x0, x16
; GISEL-CHECKED-NEXT:    ret
;
; SDAG-TRAP-LABEL: test_auth_too_large_discriminator:
; SDAG-TRAP:       ; %bb.0:
; SDAG-TRAP-NEXT:    mov w8, #65536
; SDAG-TRAP-NEXT:    bfi x1, x8, #48, #16
; SDAG-TRAP-NEXT:    mov x16, x0
; SDAG-TRAP-NEXT:    autda x16, x1
; SDAG-TRAP-NEXT:    mov x17, x16
; SDAG-TRAP-NEXT:    xpacd x17
; SDAG-TRAP-NEXT:    cmp x16, x17
; SDAG-TRAP-NEXT:    b.eq Lauth_success_4
; SDAG-TRAP-NEXT:    brk #0xc472
; SDAG-TRAP-NEXT:  Lauth_success_4:
; SDAG-TRAP-NEXT:    mov x0, x16
; SDAG-TRAP-NEXT:    ret
;
; GISEL-TRAP-LABEL: test_auth_too_large_discriminator:
; GISEL-TRAP:       ; %bb.0:
; GISEL-TRAP-NEXT:    movk x1, #0, lsl #48
; GISEL-TRAP-NEXT:    mov x16, x0
; GISEL-TRAP-NEXT:    autda x16, x1
; GISEL-TRAP-NEXT:    mov x17, x16
; GISEL-TRAP-NEXT:    xpacd x17
; GISEL-TRAP-NEXT:    cmp x16, x17
; GISEL-TRAP-NEXT:    b.eq Lauth_success_4
; GISEL-TRAP-NEXT:    brk #0xc472
; GISEL-TRAP-NEXT:  Lauth_success_4:
; GISEL-TRAP-NEXT:    mov x0, x16
; GISEL-TRAP-NEXT:    ret
