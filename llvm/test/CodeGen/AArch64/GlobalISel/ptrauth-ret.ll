; RUN: llc -mtriple arm64e-apple-darwin -global-isel -verify-machineinstrs -global-isel-abort=1 -asm-verbose=false -disable-post-ra -o - %s | FileCheck %s
