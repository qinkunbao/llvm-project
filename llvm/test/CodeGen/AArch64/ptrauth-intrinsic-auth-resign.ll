...
; RUN: llc < %s -mtriple arm64e-apple-darwin -aarch64-ptrauth-auth-checks=none -verify-machineinstrs | FileCheck %s --check-prefixes=UNCHECKED
; RUN: llc < %s -mtriple arm64e-apple-darwin                                   -verify-machineinstrs | FileCheck %s --check-prefixes=CHECKED
; RUN: llc < %s -mtriple arm64e-apple-darwin -aarch64-ptrauth-auth-checks=trap -verify-machineinstrs | FileCheck %s --check-prefixes=TRAP
