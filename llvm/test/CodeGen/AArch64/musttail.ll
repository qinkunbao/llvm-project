...
; CHECK-FAST-ISEL: ldp x10, x9, [sp]
; CHECK-FAST-ISEL: ldp x12, x11, [sp, #16]
; CHECK-FAST-ISEL: stp x10, x9, [sp, #16]
; CHECK-FAST-ISEL: stp x12, x11, [sp]
; CHECK-DAG-ISEL: ldp x10, x9, [sp]
; CHECK-DAG-ISEL: ldr q16, [sp, #16]
; CHECK-DAG-ISEL: stp x10, x9, [sp, #16]
