...
define i64 @test_db_simm9max(i64* %ptr) {
...
define i64 @test_db_uimm12max(i64* %ptr) {
...
define i64 @test_da_largeoff_12b(i64* %ptr) {
...
define i64 @test_da_largeoff_32b(i64* %ptr) {
...
define i64 @test_db_simm9min(i64* %ptr) {
...
define i64 @test_da_neg_largeoff_12b(i64* %ptr) {
...
define i64 @test_da_neg_largeoff_32b(i64* %ptr) {
...
define i64 @test_da_disc_m256(i64* %ptr, i64 %disc) {
...
define i64* @test_da_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_da_8_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_da_simm9max_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_da_uimm12max_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_db_4_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_da_largeoff_12b_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_db_m256_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_db_simm9min_wb(i64* %ptr, i64* %dst) {
...
define i64* @test_db_neg_largeoff_12b_wb(i64* %ptr, i64* %dst) {
...
define void @test_da_wb_cycle(i64* %ptr, i64* %dst, i64* %dst2, i64* %dst3) {
; CHECK-LABEL: test_da_wb_cycle:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    mov x16, x0
; CHECK-NEXT:    autdza x16
...
define i64* @test_da_8_wb_use(i64* %ptr, i64* %dst, i64* %dst2) {
; CHECK-LABEL: test_da_8_wb_use:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    mov x16, x0
; CHECK-NEXT:    autdza x16
; CHECK-NEXT:    ldraa x8, [x0, #8]!
...
define i64* @test_da_256_wb_use(i64* %ptr, i64* %dst, i64* %dst2) {
; CHECK-LABEL: test_da_256_wb_use:
; CHECK:       ; %bb.0:
; CHECK-NEXT:    mov x16, x0
; CHECK-NEXT:    autdza x16
; CHECK-NEXT:    ldraa x8, [x0, #256]!
; CHECK-NEXT:    str x8, [x1]
; CHECK-NEXT:    str x16, [x2]
; CHECK-NEXT:    ret
  %tmp0 = ptrtoint i64* %ptr to i64
...
define i64 @test_da_constdisc(i64* %ptr) {
...
define i64 @test_ib_constdisc(i64* %ptr) {
...
define i64 @test_da_addrdisc(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend_8(i64* %ptr, i64 %disc) {
...
; CHECK-NEXT:    ret
  ...
  %tmp2 = call i64 @llvm.ptrauth.auth(i64 %tmp1, i32 2, i64 %tmp0)
  %tmp3 = add i64 %tmp2, 8
  %tmp4 = inttoptr i64 %tmp3 to i64*
  %tmp5 = load i64, i64* %tmp4
  ret i64 %tmp5
}

define i64 @test_da_blend_uimm12max(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend_largeoff_32b(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend_m4(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend_simm9min(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend_neg_largeoff_32b(i64* %ptr, i64 %disc) {
...
define i64 @test_da_blend_8_wb(i64* %ptr, i64 %disc, i64* %dst) {
...
; CHECK-NEXT:    ret
  ...
  %tmp4 = inttoptr i64 %tmp3 to i64*
  %tmp5 = load i64, i64* %tmp4
  store i64 %tmp5, i64* %dst
  ret i64 %tmp3
}

define i64 @test_da_blend_simm9umax_wb(i64* %ptr, i64 %disc, i64* %dst) {
...
define i64 @test_da_blend_simm9s8max_wb(i64* %ptr, i64 %disc, i64* %dst) {
...
define i64 @test_da_blend_neg_largeoff_32b_wb(i64* %ptr, i64 %disc, i64* %dst) {
