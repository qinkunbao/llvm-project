// RUN: %clang_cc1 -no-opaque-pointers -triple arm64-apple-ios -fptrauth-calls -fptrauth-returns -fptrauth-intrinsics -emit-llvm -std=c++17 -O1 -disable-llvm-passes -fexceptions -fcxx-exceptions -o - %s | FileCheck %s
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V1]])
...
// CHECK: define linkonce_odr %[[STRUCT_S0]]* @_ZN2S0C1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[THIS:.*]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C2Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[THIS1]])
// CHECK: ret %[[STRUCT_S0]]* %[[THIS1]]

S0 gs0;

// CHECK: define linkonce_odr %[[STRUCT_S5]]* @_ZN2S5CI12S2E2S0(%[[STRUCT_S5]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[THIS:.*]], %[[STRUCT_S0]]* %[[V0:.*]])
...
// CHECK: call %[[STRUCT_S5]]* @_ZN2S5CI22S2E2S0(%[[STRUCT_S5]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[THIS1]], %[[STRUCT_S0]]* %[[V0]])
...
// CHECK: call void @_ZN2S011nonvirtual0Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V0]])

// CHECK: define linkonce_odr void @_ZN2S011nonvirtual0Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[THIS:.*]])
// CHECK: %[[THIS_ADDR:.*]] = alloca %[[STRUCT_S0]]*, align 8
// CHECK: %[[THIS1:.*]] = load %[[STRUCT_S0]]*, %[[STRUCT_S0]]** %[[THIS_ADDR]], align 8
...
// CHECK: %[[CALL1:.*]] = invoke %[[STRUCT_S1]]* @_ZN2S1C1Ev(%[[STRUCT_S1]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V3]])
...
// CHECK: %[[CALL:.*]] = call %[[STRUCT_S1]]* @_ZN2S1C1Ev(%[[STRUCT_S1]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V4]])
...
// CHECK: %[[CALL1:.*]] = invoke %[[STRUCT_S1]]* @_ZN2S1C1Ev(%[[STRUCT_S1]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V6]])
...
// CHECK: invoke %[[STRUCT_S1]]* @_ZN2S1D1Ev(%[[STRUCT_S1]]*  nonnull align {{[0-9]+}} dereferenceable(24) %[[V12]])
...
// CHECK: %[[V3:.*]] = inttoptr i64 %[[V2]] to %[[STRUCT_S1]]*
// CHECK: invoke %[[STRUCT_S1]]* @_ZN2S1D1Ev(%[[STRUCT_S1]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V0]])
...
// CHECK: invoke %[[STRUCT_S1]]* @_ZN2S1D1Ev(%[[STRUCT_S1]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V15]])
...
// CHECK: %[[CALL7:.*]] = invoke %[[STRUCT_S1]]* @_ZN2S1D1Ev(%[[STRUCT_S1]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V21]])
...
// CHECK: call nonnull align 4 dereferenceable(24) %[[STRUCT_S0]]* @_ZN2S0aSERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V1]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V0]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V3]])
...
// CHECK: invoke %[[STRUCT_S0]]* @_ZN2S0C1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V7]])
...
// CHECK: invoke nonnull align 4 dereferenceable(24) %[[STRUCT_S0]]* @_ZN2S0aSERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V13]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V10]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V16]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V20]])
// CHECK: ret void
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V30]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V34]])
...
// CHECK: %[[V9:.*]] = call i64 @llvm.ptrauth.sign(i64 %[[V8]], i32 1, i64 100)
// CHECK: %[[V10:.*]] = inttoptr i64 %[[V9]] to %[[STRUCT_S0]]*
// CHECK: invoke %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V7]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V10]])

// CHECK: %[[V11:.*]] = ptrtoint %[[STRUCT_S0]]* %[[T1]] to i64
// CHECK: %[[V12:.*]] = call i64 @llvm.ptrauth.sign(i64 %[[V11]], i32 1, i64 100)
// CHECK: %[[V13:.*]] = inttoptr i64 %[[V12]] to %[[STRUCT_S0]]*
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V13]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24)  %[[V17]])
// CHECK: ret void
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24)  %[[V25]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V3]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V4]])
...
// CHECK: invoke %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V10]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[CALL1]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V23]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V28]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V39]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V44]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[AGG_RESULT]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V7]])
// CHECK: ret void
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[AGG_RESULT]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V18]])
// CHECK: ret void
...
// CHECK: %[[V2:.*]] = call i64 @llvm.ptrauth.sign(i64 %[[V1]], i32 1, i64 100)
// CHECK: %[[V3:.*]] = inttoptr i64 %[[V2]] to %[[STRUCT_S0]]*
// CHECK: invoke %[[STRUCT_S0]]* @_ZN2S0C1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V3]])
...
// CHECK: %[[V19:.*]] = inttoptr i64 %[[V18]] to %[[STRUCT_S0]]*
// CHECK: invoke %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V16]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[V19]])
...
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V26]])
...
// CHECK: call i32 @_ZZN2S07lambda0EiENKUlvE_clEv(%[[CLASS_ANON]]* nonnull align {{[0-9]+}} dereferenceable(16) %[[REF_TMP]])
...
// CHECK: %[[V4:.*]] = inttoptr i64 %[[V3]] to %[[STRUCT_S0]]*
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0C1ERKS_(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24)  %[[V4]], %[[STRUCT_S0]]* nonnull align 4 dereferenceable(24) %[[THIS1]])
...
// CHECK: %[[CALL2:.*]] = invoke i32 @_ZZN2S07lambda1EiENKUlvE_clEv(%[[CLASS_ANON_0]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[REF_TMP]])

// CHECK: call %[[CLASS_ANON_0]]* @_ZZN2S07lambda1EiENUlvE_D1Ev(%[[CLASS_ANON_0]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[REF_TMP]])
// CHECK: ret i32 %[[CALL2]]
...
// CHECK: define linkonce_odr %[[STRUCT_S0]]* @_ZN2S0C2Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[THIS:.*]])
// CHECK: %[[THIS_ADDR:.*]] = alloca %[[STRUCT_S0]]*, align 8
// CHECK: store %[[STRUCT_S0]]* %[[THIS]], %[[STRUCT_S0]]** %[[THIS_ADDR]], align 8
// CHECK: %[[THIS1:.*]] = load %[[STRUCT_S0]]*, %[[STRUCT_S0]]** %[[THIS_ADDR]], align 8
// CHECK: ret %[[STRUCT_S0]]* %[[THIS1]]

// CHECK: define linkonce_odr %[[STRUCT_S5]]* @_ZN2S5CI22S2E2S0(%[[STRUCT_S5]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[THIS:.*]], %[[STRUCT_S0]]* %[[V0:.*]])
// CHECK: %[[THIS_ADDR:.*]] = alloca %[[STRUCT_S5]]*, align 8
// CHECK: store %[[STRUCT_S5]]* %[[THIS]], %[[STRUCT_S5]]** %[[THIS_ADDR]], align 8
// CHECK: %[[THIS1:.*]] = load %[[STRUCT_S5]]*, %[[STRUCT_S5]]** %[[THIS_ADDR]], align 8
// CHECK: %[[V1:.*]] = bitcast %[[STRUCT_S5]]* %[[THIS1]] to %[[STRUCT_S2]]*
// CHECK: call %[[STRUCT_S2]]* @_ZN2S2C2E2S0(%[[STRUCT_S2]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[V1]], %[[STRUCT_S0]]* %[[V0]])
// CHECK: ret %[[STRUCT_S5]]* %[[THIS1]]
...
// CHECK: define linkonce_odr %[[CLASS_ANON_0]]* @_ZZN2S07lambda1EiENUlvE_D1Ev(%[[CLASS_ANON_0]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[THIS]]) unnamed_addr
// CHECK: %[[THIS_ADDR:.*]] = alloca %[[CLASS_ANON_0]]*, align 8
// CHECK: %[[THIS1:.*]] = load %[[CLASS_ANON_0]]*, %[[CLASS_ANON_0]]** %[[THIS_ADDR]], align 8
// CHECK: [[CLASS_ANON_0]]* @_ZZN2S07lambda1EiENUlvE_D2Ev(%[[CLASS_ANON_0]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[THIS1]])

// CHECK: define linkonce_odr %[[CLASS_ANON_0]]* @_ZZN2S07lambda1EiENUlvE_D2Ev(%[[CLASS_ANON_0]]* nonnull align {{[0-9]+}} dereferenceable(28) %[[THIS]]) unnamed_addr
// CHECK: %[[THIS_ADDR:.*]] = alloca %[[CLASS_ANON_0]]*, align 8
// CHECK: %[[THIS1:.*]] = load %[[CLASS_ANON_0]]*, %[[CLASS_ANON_0]]** %[[THIS_ADDR]], align 8
// CHECK: %[[V0:.*]] = getelementptr inbounds %[[CLASS_ANON_0]], %[[CLASS_ANON_0]]* %[[THIS1]], i32 0, i32 0
// CHECK: %[[V1:.*]] = ptrtoint %[[STRUCT_S0]]* %[[V0]] to i64
// CHECK: %[[V2:.*]] = call i64 @llvm.ptrauth.sign(i64 %[[V1]], i32 1, i64 100)
// CHECK: %[[V3:.*]] = inttoptr i64 %[[V2]] to %[[STRUCT_S0]]*
// CHECK: call %[[STRUCT_S0]]* @_ZN2S0D1Ev(%[[STRUCT_S0]]* nonnull align {{[0-9]+}} dereferenceable(24) %[[V3]])
