...
// CHECK-NEXT:  [[T2:%.*]] = call noundef i8* [[T1]](%struct.A* {{.*}}) [ "ptrauth"(i32 0, i64 [[BT1]]) ]
...
// CHECK-NEXT:  [[U2:%.*]] = call noundef i8* [[U1]](%struct.Base* {{.*}}) [ "ptrauth"(i32 0, i64 [[BU1]]) ]
  char* c = p->Base::abc();
}
...
// CHECK-NEXT:  [[V2:%.*]] = call noundef i8* [[V1]](%struct.Derived2* {{.*}}) [ "ptrauth"(i32 0, i64 [[BV1]]) ]
...
// CHECK-NEXT:  [[W2:%.*]] = call noundef i8* [[W1]](%struct.D2* {{.*}}) [ "ptrauth"(i32 0, i64 [[BW1]]) ]
  char* c = p->D2::abc();
}
