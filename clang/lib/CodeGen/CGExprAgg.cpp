...
void AggExprEmitter::withReturnValueSlot(
  ...
  assert(Dest.getAddress().isSigned() || Src.isSignedAggregate() ||
...
AggExprEmitter::VisitCXXStdInitializerListExpr(CXXStdInitializerListExpr *E) {
  ...
  llvm::Value *ArrayStart = Builder.CreateInBoundsGEP(
      ArrayPtr.getRawPointer(CGF), IdxStart, "arraystart");
  ...
  if (Field->getType()->isPointerType() &&
    ...
    llvm::Value *ArrayEnd = Builder.CreateInBoundsGEP(
        ArrayPtr.getRawPointer(CGF), IdxEnd, "arrayend");
...
void AggExprEmitter::EmitArrayInit(Address DestPtr, llvm::ArrayType *AType,
  ...
  llvm::Value *begin = Builder.CreateInBoundsGEP(DestPtr.getRawPointer(CGF),
